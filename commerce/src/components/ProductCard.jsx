    ...
    <div style={{ marginTop: '200px'}}>
      ...
      <div >
        <div className='product-card'>
          <Card className='card' sx={{ width: '300px', height: '580px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', margin: '30px', marginBottom: '-150px', cursor: 'pointer', boxShadow: '1px 1px 5px 5px whitesmoke' }}>
